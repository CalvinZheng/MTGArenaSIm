...
extension NumberConvertible {
    ...
    public func convert<T: NumberConvertible>() -> T {
        switch self {
...
extension NumberConvertible {
    ...
    public typealias CombineType = (PreferredType,PreferredType) -> PreferredType
    
    public func operate<T:NumberConvertible,V:NumberConvertible>(b:T, combine:CombineType) -> V{
...
public func + <T:NumberConvertible, U:NumberConvertible,V:NumberConvertible>(lhs: T, rhs: U) -> V {
	return lhs.operate(b: rhs, combine: + )
}
